...
def Options():
    ...
    # ---------------------------------------------General options---------------------------------------------------------
    parser.add_option('--name', dest='name', default='3601_CGLS91_DenseNetLRandThres64_test_0123', type='string', help='Name of Experiment')
    ...
    # -----------------------------------------------Data options----------------------------------------------------------
    parser.add_option('--input-filename', dest='input_filename', default='/db/psxdb3/havok/db1/tomo_p1_astra_recon_gpu_91_norm.h5', type='string', help='Select Input Filename')
    ...
    parser.add_option('--pre-filename', dest='preprocess_filename', default='/home/psxdb3/OneDrive/SemSegCT_Networks/Fold_3/3601_CGLS91_DenseNetLRandThres64_4_0123/Checkpoints/2D_slices.npz', type='string', help='Output Area in relation with the Input (default: 2,0,0,1,512,512 )')
