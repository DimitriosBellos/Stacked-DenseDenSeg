...
def Options():
    ...
    # ---------------------------------------------General options---------------------------------------------------------
    parser.add_option('--name', dest='name', default='3601_CGLS91_DenseNetLRandThres64_Denoise3_0123', type='string', help='Name of Experiment')
    ...
    parser.add_option('--prenet', action='store_false', dest='prenet', default=True, help='Use Parallel Gpus (True/False)')
    # ----------------------------------------------Model options----------------------------------------------------------
    parser.add_option('--num-classes', dest='n_classes', default=1, type='int', help='Set Number of Classes (default:3)')
    ...
    parser.add_option('--model_type', dest='model_type', default='DenseNet', type='choice', choices=['MSD', 'UNet', 'DenseNet'], help='Select Model type')
    ...
    parser.add_option('--load', dest='load', default='Best_model.pth', type='string', help='Load Saved Model')  # TODO
    ...
    parser.add_option('--dice', dest='dice', default='MSE', type='choice', choices=['MSE', 'Dice', 'CrossEntropy'], help='Select if the training is Deterministic')
    # -----------------------------------------------Data options----------------------------------------------------------
    parser.add_option('--input-filename', dest='input_filename', default='/db/psxdb3/havok/db1/tomo_p1_astra_recon_gpu_91.h5', type='string', help='Select Input Filename')
    parser.add_option('--annotations-filename', dest='annotations_filename', default='/db/psxdb3/havok/db1/tomo_p2_astra_recon_gpu.h5', type='string', help='Select Annotations Filename')
    ...
    parser.add_option('--prunned-classes', dest='prunned_classes', default='None', type='string', help='Classes that should be replaced by other classes (Default: None)')
    # --------------------------------------------Validation options-------------------------------------------------------
    ...
    parser.add_option('--root', dest='root', default='/home/psxdb3/OneDrive/SemSegCT_Networks/Fold_3/', type='string', help='Root Directory')
