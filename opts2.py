...
def Options():
    ...
    # ---------------------------------------------General options---------------------------------------------------------
    parser.add_option('--name', dest='name', default='3601_Synth_DenseUNetStack_Original_0123_AttemptOldPatchesClsHigh5_50p', type='string', help='Name of Experiment')
    ...
    parser.add_option('--gpu-devices', dest='gpu_devices', default=2, type='int', help='Select CUDA_VISIBLE_DEVICES (default:0)')
    parser.add_option('--gpu-devices-sp', dest='gpu_devices_sp', default='0,1', type='string', help='Select CUDA_VISIBLE_DEVICES (default:0)')
    ...
    parser.add_option('--intermediate-filename', dest='intermediate_filename', default='/db/psxdb3/havok/db1/tomo_p2_astra_recon_gpu.h5', type='string', help='Select Intermediate Filename')
    ...
    parser.add_option('--root', dest='root', default='/home/psxdb3/OneDrive/SemSegCT_Networks/Synth/synth2/', type='string', help='Root Directory')
    parser.add_option('--cp-dest', dest='cp_dest', default='/CheckpointsReal/', type='string', help='Checkpoints Save Directory')
    parser.add_option('--im-dest', dest='im_dest', default='/ImagesReal/', type='string', help='Images Save Directory')
    parser.add_option('--tb-dest', dest='tb_dest', default='/TensorboardReal/', type='string', help='Tensorboard Directory')
    return parser