...
def Options():
    ...
    # ---------------------------------------------General options---------------------------------------------------------
    parser.add_option('--name', dest='name', default='3601_Synth_DenseUSegStack_Original_0123_AttemptOldPatchesClsHigh5_50p', type='string', help='Name of Experiment')
    ...
    # -----------------------------------------------Data options----------------------------------------------------------
    parser.add_option('--input-filename', dest='input_filename', default='/db/user/db1/tomo_p1_astra_recon_gpu_91.h5', type='string', help='Select Input Filename')
    ...
    parser.add_option('--intermediate-filename', dest='intermediate_filename', default='/db/user/db1/tomo_p2_astra_recon_gpu.h5', type='string', help='Select Intermediate Filename')
    ...
    parser.add_option('--root', dest='root', default='/home/user/OneDrive/SemSegCT_Networks/Synth/synth2/', type='string', help='Root Directory')
