...
def Options():
    ...
    # ---------------------------------------------General options---------------------------------------------------------
    parser.add_option('--name', dest='name', default='4D_9_infer2', type='string', help='Name of Experiment')
    ...
    parser.add_option('--gpu-devices', dest='gpu_devices', default=4, type='int', help='Select CUDA_VISIBLE_DEVICES (default:0)')
    parser.add_option('--cores', dest='cores', default=32, type='int', help='Select CUDA_VISIBLE_DEVICES (default:0)')
    parser.add_option('--memory', dest='memory', default=40, type='int', help='Select CUDA_VISIBLE_DEVICES (default:0)')
    parser.add_option('--parallel', action='store_false', dest='parallel', default=True, help='Use Parallel Gpus (True/False)')
    parser.add_option('--prenet', action='store_true', dest='prenet', default=False, help='Use Parallel Gpus (True/False)')
    # ----------------------------------------------Model options----------------------------------------------------------
    ...
    parser.add_option('--model_type', dest='model_type', default='DenseUNetStack', type='choice', choices=['MSD', 'UNet', 'DenseUNetStack'],  help='Select Model type')
    ...
    parser.add_option('--learning-rate', dest='lr', default=0.00001, type='float', help='Learning Rate (default:0.001)')
    ...
    parser.add_option('--batch-size', dest='batchsize', default=64, type='int', help='Batch Size (default:8)')
    parser.add_option('--num-workers', dest='workers', default=40, type='int', help='Workers Number (default:8)')
    ...
    parser.add_option('--load', dest='load', default='/home/psxdb3/OneDrive/SemSegCT_Networks/Synth/synth3/3601_Synth_DenseUNetStack_RealisticV2_0123_AttemptOldPatchesClsHigh5/Checkpoints/Best_model.pth', type='string', help='Load Saved Model')
    ...
    parser.add_option('--dice', dest='dice', default='Mixed', type='choice', choices=['MSE', 'Dice', 'CrossEntropy', 'Mixed'], help='Select if the training is Deterministic')
    parser.add_option('--testing-case', action='store_true', dest='testing_case', default=False, help='Select if the training is Deterministic')
    # -----------------------------------------------Data options----------------------------------------------------------
    parser.add_option('--input-filename', dest='input_filename', default='/db/psxdb3/4D/4D_9.h5', type='string', help='Select Input Filename')
    parser.add_option('--annotations-filename', dest='annotations_filename', default='/db/psxdb3/4D/4D_9_infer2/Pred2_9.h5', type='string', help='Select Annotations Filename')
    parser.add_option('--intermediate-filename', dest='intermediate_filename', default='/db/psxdb3/4D/4D_9_infer2/Pred2_9_den.h5', type='string', help='Select Intermediate Filename')
    parser.add_option('--preprocess-filename', dest='preprocess_filename', default='None', type='string', help='Select Annotations Filename')
    parser.add_option('--input-size', dest='input_size', default='64,64,64', type='string', help='Input Size (default: 5,512,512 )')
    parser.add_option('--input-area', dest='input_area', default='1190,800,50,1702,1420,562', type='string', help='Input Area (default: 1186,0,0,2160,2560,2560 )')
    ...
    parser.add_option('--input-stride', dest='input_stride', default='32,32,32', type='string', help='Input stride (default:1,512,512)')
    ...
    parser.add_option('--root', dest='root', default='/db/psxdb3/4D/', type='string', help='Root Directory')
