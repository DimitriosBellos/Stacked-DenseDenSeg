...
def Options():
    ...
    # ---------------------------------------------General options---------------------------------------------------------
    parser.add_option('--name', dest='name', default='3601_CGLS91_DenseNetLRandThres64_NDP_0123', type='string', help='Name of Experiment')
    ...
    parser.add_option('--gpu-devices', dest='gpu_devices', default=1, type='int', help='Select CUDA_VISIBLE_DEVICES (default:0)')
    ...
    parser.add_option('--annotations-filename', dest='annotations_filename', default='/db/psxdb3/havok/db1/annotations/annotations0.h5', type='string', help='Select Annotations Filename')
    parser.add_option('--preprocess-filename', dest='preprocess_filename', default='/home/psxdb3/OneDrive/SemSegCT_Networks/DenseNet/3601_CGLS91_DenseNetLRandThres64_6_0123/Checkpoints/2D_slices.npz', type='string', help='Select Annotations Filename')
    ...
    parser.add_option('--root', dest='root', default='/home/psxdb3/OneDrive/SemSegCT_Networks/DenseNet/', type='string', help='Root Directory')
