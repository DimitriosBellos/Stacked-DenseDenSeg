...
def Options():
    ...
    parser.add_option('--model_type', dest='model_type', default='DenseUSegStack', type='choice', choices=['DenseUSegStack',],  help='Select Model type')
    ...
    parser.add_option('--load', dest='load', default='/home/user/OneDrive/SemSegCT_Networks/Synth/synth3/3601_Synth_DenseUSegStack_RealisticV2_0123_AttemptOldPatchesClsHigh5/Checkpoints/Best_model.pth', type='string', help='Load Saved Model')
    ...
    # -----------------------------------------------Data options----------------------------------------------------------
    parser.add_option('--input-filename', dest='input_filename', default='/db/user/4D/4D_9.h5', type='string', help='Select Input Filename')
    parser.add_option('--annotations-filename', dest='annotations_filename', default='/db/user/4D/4D_9_infer2/Pred2_9.h5', type='string', help='Select Annotations Filename')
    parser.add_option('--intermediate-filename', dest='intermediate_filename', default='/db/user/4D/4D_9_infer2/Pred2_9_den.h5', type='string', help='Select Intermediate Filename')
    ...
    parser.add_option('--root', dest='root', default='/db/user/4D/', type='string', help='Root Directory')
