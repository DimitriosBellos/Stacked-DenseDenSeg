...
class DenseNet5L(nn.Module):
    def __init__(self, n_channels, n_classes, ignore_class=-100, k0=32, Theta=0.5, Dropout=0.2, Growth_rate=16, Kernel_size=3, Batchnorm=True, Stride=1, Padding=1, Bias=False):
        super(DenseNet5L, self).__init__()
        self.inc = inconv(n_channels, k0, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.down = conv_layer2(k0, k0, Batchnorm, 2, 2, 0, Bias)
        self.db1 = DenseBlock(k0, Growth_rate, Dropout, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.in_ch = int(k0 + 4 * Growth_rate)
...
class DenseNetDenoise(nn.Module):
    def __init__(self, n_channels, n_classes, ignore_class=-100, k0=32, Theta=0.5, Dropout=0.2, Growth_rate=16, Kernel_size=3, Batchnorm=True, Stride=1, Padding=1, Bias=False):
        super(DenseNetDenoise, self).__init__()
        #self.inc = inconv(n_channels, k0, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.down = conv_layer2(k0, k0, Batchnorm, 2, 2, 0, Bias)
        self.db1 = DenseBlock(k0, Growth_rate, Dropout, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.in_ch = int(k0 + 4 * Growth_rate)
...
class DenseUNetStack(nn.Module):
    def __init__(self, n_channels, n_classes, ignore_class=-100, k0=32, Theta=0.5, Dropout=0.2, Growth_rate=16, Kernel_size=3, Batchnorm=True, Stride=1, Padding=1, Bias=False):
        super(DenseUNetStack, self).__init__()
        self.inc = inconv(n_channels, k0, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.D1 = DenseUNetDenoise(n_channels, 1, ignore_class, k0, Theta, Dropout, Growth_rate, Kernel_size, Batchnorm, Stride, Padding, Bias)
...
class DenseNetHalfScope(nn.Module):
    def __init__(self, n_channels, n_classes, ignore_class=-100, k0=32, Theta=0.5, Dropout=0.2, Growth_rate=16, Kernel_size=3, Batchnorm=True, Stride=1, Padding=1, Bias=False):
        super(DenseNetHalfScope, self).__init__()
        self.inc = inconv(n_channels, k0, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.down = conv_layer2(k0, k0, Batchnorm, 2, 2, 0, Bias)
        self.db1 = DenseBlock(k0, Growth_rate, Dropout, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.in_ch = int(k0 + 4 * Growth_rate)
...
class DenseNet2_5(nn.Module):
    def __init__(self, n_channels, n_classes, ignore_class=-100, k0=32, Theta=0.5, Dropout=0.2, Growth_rate=16, Kernel_size=3, Batchnorm=True, Stride=1, Padding=1, Bias=False):
        super(DenseNet2_5, self).__init__()
        self.inc = inconv(n_channels, k0, Batchnorm, Kernel_size, Stride, Padding, Bias)
...
class Dense2DNet(nn.Module):
    def __init__(self, n_channels, n_classes, ignore_class=-100, k0=32, Theta=0.5, Dropout=0.2, Growth_rate=16, Kernel_size=3, Batchnorm=True, Stride=1, Padding=1, Bias=False):
        super(Dense2DNet, self).__init__()
...
class Dense2DNet5L(nn.Module):
    def __init__(self, n_channels, n_classes, ignore_class=-100, k0=32, Theta=0.5, Dropout=0.2, Growth_rate=16, Kernel_size=3, Batchnorm=True, Stride=1, Padding=1, Bias=False):
        super(Dense2DNet5L, self).__init__()
        self.inc = inconv_2D(n_channels, k0, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.down = conv_layer2_2D(k0, k0, Batchnorm, 2, 2, 0, Bias)
        self.db1 = DenseBlock_2D(k0, Growth_rate, Dropout, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.in_ch = int(k0 + 4 * Growth_rate)
...
class Dense2DNetDenoise(nn.Module):
    def __init__(self, n_channels, n_classes, ignore_class=-100, k0=32, Theta=0.5, Dropout=0.2, Growth_rate=16, Kernel_size=3, Batchnorm=True, Stride=1, Padding=1, Bias=False):
        super(Dense2DNetDenoise, self).__init__()
        #self.inc = inconv_2D(n_channels, k0, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.down = conv_layer2_2D(k0, k0, Batchnorm, 2, 2, 0, Bias)
        self.db1 = DenseBlock_2D(k0, Growth_rate, Dropout, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.in_ch = int(k0 + 4 * Growth_rate)
...
class DenseNetStack_2D(nn.Module):
    def __init__(self, n_channels, n_classes, ignore_class=-100, k0=32, Theta=0.5, Dropout=0.2, Growth_rate=16, Kernel_size=3, Batchnorm=True, Stride=1, Padding=1, Bias=False):
        super(DenseNetStack_2D, self).__init__()
        self.inc = inconv_2D(n_channels, k0, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.D1 = Dense2DNetDenoise(n_channels, 1, ignore_class, k0, Theta, Dropout, Growth_rate, Kernel_size, Batchnorm, Stride, Padding, Bias)
        ...
        self.D2 = Dense2DNet(n_channels, n_classes, ignore_class, k0, Theta, Dropout, Growth_rate, Kernel_size, Batchnorm, Stride, Padding, Bias)
...
class DenseUNetDenoise2D(nn.Module):
    def __init__(self, n_channels, n_classes, ignore_class=-100, k0=32, Theta=0.5, Dropout=0.2, Growth_rate=16, Kernel_size=3, Batchnorm=True, Stride=1, Padding=1, Bias=False):
        super(DenseUNetDenoise2D, self).__init__()
        #self.inc = inconv_2D(n_channels, k0, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.down = conv_layer2_2D(k0, k0, Batchnorm, 2, 2, 0, Bias)
...
class DenseUNetStack_2D(nn.Module):
    def __init__(self, n_channels, n_classes, ignore_class=-100, k0=32, Theta=0.5, Dropout=0.2, Growth_rate=16, Kernel_size=3, Batchnorm=True, Stride=1, Padding=1, Bias=False):
        super(DenseUNetStack_2D, self).__init__()
        self.inc = inconv_2D(n_channels, k0, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.D1 = DenseUNetDenoise2D(n_channels, 1, ignore_class, k0, Theta, Dropout, Growth_rate, Kernel_size, Batchnorm, Stride, Padding, Bias)
        self.c1a = conv_layer2_2D(k0, k0, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.c1b = conv_layer2_2D(k0, k0, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.c2b = conv_layer2_2D(1, k0, Batchnorm, Kernel_size, Stride, Padding, Bias)
        self.D2 = DenseUNet2D(n_channels, n_classes, ignore_class, k0, Theta, Dropout, Growth_rate, Kernel_size, Batchnorm, Stride, Padding, Bias)
